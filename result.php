<?php echo "<div style = 'width :600px;padding: 30px;border: 1px dashed red ;display: grid;justify-content: center; align-items: center;'>" ?>

<?php 
    echo "<img src='huy_chuong.jpg' alt='Hình ảnh huy chương'/>";
    if(isset($_POST['name'])){
